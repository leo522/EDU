<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="OutstandingPerformance.aspx.cs" Inherits="OutstandingPerformance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:Label ID="Label3" runat="server" Text="&gt;我的傑出表現" ></asp:Label>
    ...
    <div>
        ...
        <asp:Button ID="Btn_Upload" class="btn btn-warning" runat="server" Text="上傳檔案" OnClick="Btn_Upload_Click"/>--%>
    ...
    <div>
        ...
        <div>
            ...
            <input name="Competition" type="text" placeholder="範例：實證醫學-金獎" required title="此欄位為必填項目"/>
             <asp:Label ID="Participant" runat="server" Text=""></asp:Label> <%--顯示參與人員--%>
        </div><hr />
       
<%--        
        <div>
            <label for="TeamCompetition">團隊參賽主題：</label>
            <input name="TeamCompetition" type="text"/>
        </div><hr />

        <div class="form-Eventrow">
            <label for="EventAward">活動名稱：</label>
            <input name="EventAward" type="text" placeholder="實證醫學" />
        </div><hr />--%>

      <%--  <div>
            <span style="color:red">*</span>
            <label for="Awards">獎項名稱/得獎名次：</label>
            <input name="Awards" type="text" placeholder="金獎" required/>
        </div><hr />--%>

        <div class="form-Organrow">
            <label for="Organization">主辦單位：</label>
            <input name="Organization" type="text" placeholder="範例：醫策會" required title="此欄位為必填項目"/>
        </div> <hr />
        ...
        <div>
            ...
            <asp:Label ID="ReviewStatusLabel" runat="server" Text=""></asp:Label><br/><br/>
...
<%--    <div>
        ...
        <asp:Button ID="btn_Serach" runat="server" Text="查詢圖片" OnClick="btn_Serach_Click" />
