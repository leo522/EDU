<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" ValidateRequest="false" CodeFile="TemplateDetial.aspx.cs" Inherits="TemplateDetial" %>
...
<div>
    ...
    <asp:Label ID="lbTitle" runat="server" Font-Bold="True" Font-Size="Medium"></asp:Label>
