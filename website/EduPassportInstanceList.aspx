<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="EduPassportInstanceList.aspx.cs" Inherits="EduPassportInstanceList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <div>
        <asp:Label ID="lbMsg" runat="server" Font-Bold="True" Font-Size="Large" ForeColor="Blue" Text="您有{0}本學習護照可領取" Visible="False"></asp:Label>
    </div>
    <div>
                        ...
                        <Columns>
                            <telerik:GridTemplateColumn FilterControlAltText="Filter TemplateColumn column" UniqueName="TemplateColumn">
                                <ItemTemplate>
                                    ...
                                    <asp:Button ID="btnGet" runat="server" Text="領取" OnClick="btnGet_Click" />
                                </ItemTemplate>
                            ...
                            <telerik:GridDateTimeColumn DataField="createdate" FilterControlAltText="Filter createdate column" HeaderText="建立日期" UniqueName="createdate">
                            </telerik:GridDateTimeColumn>
                            <telerik:GridBoundColumn DataField="FinishRateStr" FilterControlAltText="Filter ModifyDate column" HeaderText="完成狀況" UniqueName="FinishRateStr">
                            </telerik:GridBoundColumn>
