<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="TeachTimeQuery.aspx.cs" Inherits="TeachTimeQuery" %>
...
<telerik:RadGrid ID="rgJobCode" runat="server" AutoGenerateColumns="False" CellSpacing="0" GridLines="None" OnDeleteCommand="rgJobCode_DeleteCommand" OnNeedDataSource="rgJobCode_NeedDataSource" AutoGenerateDeleteColumn="True">
    ...
    <table>
        <tr>
            ...
            <td>&nbsp;</td>
            <td>
                <asp:Button ID="btnToKPI" runat="server" Text="匯出貢獻度格式檔" OnClick="btnToKPI_Click" Visible="False" />
            </td>
            <td></td>
        </tr>
    </table>
