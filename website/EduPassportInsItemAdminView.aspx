<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="EduPassportInsItemAdminView.aspx.cs" Inherits="EduPassportInsItemTeacherView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <div>
        <asp:Button ID="btnConfirmAll" runat="server" OnClick="btnConfirmAll_Click" Text="勾選項目全部審核" />
    </div>
