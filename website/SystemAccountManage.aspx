<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="SystemAccountManage.aspx.cs" Inherits="SystemAccountManage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
                    ...
                    <telerik:RadGrid ID="RadGrid1" runat="server" AutoGenerateColumns="False" AutoGenerateDeleteColumn="True" CellSpacing="0" Culture="zh-TW" GridLines="None" OnDeleteCommand="RadGrid1_DeleteCommand" OnNeedDataSource="RadGrid1_NeedDataSource" AllowMultiRowSelection="True">
                        ...
                        <MasterTableView DataKeyNames="ID">
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="sdate" FilterControlAltText="Filter classtype column" HeaderText="有效起日" UniqueName="sdate">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="edate" FilterControlAltText="Filter TrainingTime column" HeaderText="有效迄日" UniqueName="edate">
                                </telerik:GridBoundColumn>
                            </Columns>
                        </MasterTableView>
                    </telerik:RadGrid>
    ...
    <div>
                ...
                <asp:Panel ID="Panel2" runat="server" GroupingText="Step1 - 下載匯入格式範例">
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/docs/帳號登入權限匯入範例.xls">下載</asp:HyperLink>
