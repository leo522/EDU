<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="TrainingPointManage.aspx.cs" Inherits="TrainingPointManage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div>
                ...
                <asp:Panel ID="Panel2" runat="server" GroupingText="Step1 - 下載匯入格式範例">
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/docs/訓練時數匯入範例.xls">下載</asp:HyperLink>
