<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="EduPassportManageSend.aspx.cs" Inherits="EduPassportManageSend" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
        ...
        <table>
            <tr>
                <td>
                    ...
                    <asp:Button ID="btnToImport" runat="server" Text="進入護照資料匯入頁面" OnClick="btnToImport_Click" />
    ...
    <div>
                ...
                <asp:Panel ID="Panel2" runat="server" GroupingText="Step2 - 選擇學員">
    ...
    <div>
        ...
        <asp:Panel ID="Panel3" runat="server" GroupingText="Step3 - 發出">
            <asp:Button ID="btnSend" runat="server" Text="發送" OnClick="btnImport_Click" style="height: 21px" />
        </asp:Panel>
