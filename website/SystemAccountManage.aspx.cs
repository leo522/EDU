...
public partial class SystemAccountManage : AuthPage
{
    private List<AccountDto> CurrentData
    {
        get
        {
            return ViewState["CurrentData"] as List<AccountDto>;
        }
        set
        {
    ...
    protected void btnImport_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            List<string[]> result = service.ImportSystemAccount(dt, this.EmpCode);
    ...
    {
        List<AccountDto> data = service.QuerySystemAccount(tbEmpCodeName.Text.Trim());
        CurrentData = data;
    ...
    protected void RadGrid1_DeleteCommand(object sender, GridCommandEventArgs e)
    {
        if (e.Item is GridDataItem)
        {
            ...
            ids.Add(id);
            string result = service.DeleteSystemAccount(ids);
            if (result != null)
            {
