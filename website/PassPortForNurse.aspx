<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="PassPortForNurse.aspx.cs" Inherits="PassPortForNurse" %>
        ...
        <tr>
            <td class="auto-style4">
                <table>
                    <tr>
                        <td>
                <asp:Label ID="Label1" runat="server" Text="請輸入人員職編或姓名:" CssClass="auto-style5" Font-Bold="True" Font-Size="Large"></asp:Label>
                <asp:TextBox ID="txtSearchEmpCode" runat="server" Style="margin-left: 0px" CssClass="auto-style5" Font-Bold="true" Font-Size="Large"></asp:TextBox>
                        ...
                        <td>
                            ...
                            <asp:Panel ID="panMultiEmp" runat="server" Visible="False">
                                <asp:Label ID="Label4" runat="server" Text="找到多筆資料(請選擇):" CssClass="auto-style5" Font-Bold="True" Font-Size="Large"></asp:Label>
                                <asp:DropDownList ID="ddlMultiEmp" runat="server" Width="200px" OnSelectedIndexChanged="ddlMultiEmp_SelectedIndexChanged" AutoPostBack="True">
                                </asp:DropDownList>
                            </asp:Panel>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dsEduActivity %>" SelectCommand="SELECT [empcode], [empname], case when @empcode = '1020640' then 'CKAC' when jobcode = 'CLERK' then (select membertype from member where ishospmember = @empcode and getdate() between datefrom and dateto ) else [jobcode] end as jobcode FROM [V_KmuEmp] WHERE ([empcode] = @empcode)">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="ddlMultiEmp" Name="empcode" PropertyName="SelectedValue" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
                &nbsp;
                        ...
                        <tr>
                            <td>
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblCheckTeacher" runat="server" ToolTip='<%# Eval("teacherremark") %>' Text='<%# Eval("empname") %>' Width="165px" BackColor="#FFFFCC" Font-Bold="True" Font-Size="Medium" ForeColor="#000099"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center">
...
<%--                        <tr>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblCheckTeacher1" runat="server" ToolTip='<%# Eval("teacherremark1") %>' Text='<%# Eval("empname1") %>' Width="165px" BackColor="#CCFFCC" Font-Bold="True" Font-Size="Medium" ForeColor="#000099"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center">
...
<%--                        <tr>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblCheckTeacher2" runat="server" ToolTip='<%# Eval("teacherremark2") %>' Text='<%# Eval("empname2") %>' Width="165px" Font-Bold="True" Font-Size="Medium" ForeColor="#000099" BackColor="#FFCCCC"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center">
...
order by PassPortCheckItem.itemCode">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="ddlMultiEmp" Name="empcode" PropertyName="SelectedValue" />
