<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="EduScoreManage.aspx.cs" Inherits="EduScoreManage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            <td>
                                ...
                                <asp:Label ID="Label1" runat="server" Text="建立日期："></asp:Label>
                    ...
                    <telerik:RadGrid ID="RadGrid1" runat="server" AutoGenerateColumns="False" AutoGenerateDeleteColumn="True" CellSpacing="0" Culture="zh-TW" GridLines="None" OnDeleteCommand="RadGrid1_DeleteCommand" OnNeedDataSource="RadGrid1_NeedDataSource" AllowMultiRowSelection="True">
                        ...
                        <MasterTableView DataKeyNames="ID">
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="deplevel" FilterControlAltText="Filter deplevel column" HeaderText="系級" UniqueName="deplevel">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="classname" FilterControlAltText="Filter classname column" HeaderText="實習課程名稱" UniqueName="classname">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="Score" FilterControlAltText="Filter TrainingTime column" HeaderText="總成績" UniqueName="Score">
                                </telerik:GridBoundColumn>
                            </Columns>
                        </MasterTableView>
                    </telerik:RadGrid>
    ...
    <div>
                ...
                <asp:Panel ID="Panel2" runat="server" GroupingText="Step1 - 下載匯入格式範例">
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/docs/實習各階段評量匯入範例.xls">下載</asp:HyperLink>
