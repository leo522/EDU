...
public partial class OSCEScoreManager : AuthPage
{
    ...
    private void ReadData()
    {
        ...
        List<IKASA_OSCEExamDto> list = service.GetiKasaOSCEExams(tbExamName.Text, rdpExamDate.SelectedDate);
        ...
        if (e.CommandName != RadGrid.DeleteSelectedCommandName)
        {
            if (e.Item is GridDataItem)
            {
                if ((e.Item as GridDataItem).GetDataKeyValue("ExamID") != null)
                {
                    ...
                    service.DeleteiKasaOSCEExam(examid);
    ...
    protected void RadGrid1_ItemCreated(object sender, GridItemEventArgs e)
    {
        ...
        if (lbtn != null)
        {
            ...
            {
                string examid = (e.Item as GridDataItem).GetDataKeyValue("ExamID").ToString();
                lbtn.OnClientClick = "location.href='OSCEScoreEdit.aspx?examid=" + examid + "';return false;";
            }
