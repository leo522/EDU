...
public partial class MedicalTeachPointUpload : AuthPage
{
    ...
    {
        List<MedicalTeachPointDto> list = service.ReadMedicalTeachPoint(ddlYear.SelectedValue, ddlMonth.SelectedValue, DeptSelector1.SelectDept.Hospcode, DeptSelector1.SelectDept.Deptcode);
