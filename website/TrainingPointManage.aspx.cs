...
public partial class TrainingPointManage : AuthPage
{
    ...
    protected void btnImport_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            List<string[]> result = service.UploadTrainingTimeData(dt, this.EmpCode);
    ...
    {
        List<TrainingTimeDto> data = service.QueryTrainingTimeEmpItemData(tbEmpCodeName.Text.Trim(), tbCreater.Text.Trim(), rdpSdate.SelectedDate, rdpEdate.SelectedDate, rdpCreateSdate.SelectedDate, rdpCreateEdate.SelectedDate, null);
        CurrentData = data;
    ...
    protected void RadGrid1_DeleteCommand(object sender, GridCommandEventArgs e)
    {
        if (e.Item is GridDataItem)
        {
            ...
            ids.Add(id);
            string result = service.DeleteTrainingTimeEmpItemData(ids);
            if (result != null)
            {
