<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="iKasaStudentList.aspx.cs" Inherits="iKasaStudentList" %>
   ...
   <script type="text/javascript">
    ...
    <table>
        <tr>
            ...
            <td>
                <asp:Label ID="Label11" runat="server" Text="學員職編："></asp:Label>
            </td>
            <td>
...
<MasterTableView nomasterrecordstext="目前沒有資料" GroupLoadMode="Client" DataKeyNames="EmpCode,IDNo" >
    ...
    <Columns>
        <telerik:GridTemplateColumn FilterControlAltText="Filter TemplateColumn column" UniqueName="TemplateColumn">
            <ItemTemplate>
                ...
                <asp:Button ID="btniKasaTest" runat="server" Text="i-KASA(test)" OnClick="btntest_Click" />
            </ItemTemplate>
        ...
        <telerik:GridBoundColumn DataField="EduTermName" FilterControlAltText="Filter EduTermName column" HeaderText="實習期間" UniqueName="EduTermName">
        </telerik:GridBoundColumn>
    </Columns>
</MasterTableView>
