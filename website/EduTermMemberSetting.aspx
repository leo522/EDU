<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="EduTermMemberSetting.aspx.cs" Inherits="EduTermMemberSetting" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    Culture="zh-TW" GridLines="None" AllowMultiRowSelection="True" 
        ...
        AutoGenerateHierarchy="True" PageSize="20" OnItemDataBound="RadGrid1_ItemDataBound">
...
<HeaderStyle Width="20px"></HeaderStyle>
    ...
    <Columns>
        <telerik:GridBoundColumn DataField="EduStopCode" 
            ...
            UniqueName="EduStopCode" Visible="False">
        ...
        <telerik:GridTemplateColumn FilterControlAltText="Filter TeamSelector column" HeaderText="設定組別" UniqueName="TeamSelector">
            <ItemTemplate>
                        <telerik:RadDropDownTree ID="RadDropDownTree1" EnableViewState ="true" runat="server" DataValueField="EduTeamCode" DataFieldParentID="parentEduTeamCode" 
        DataTextField="EduTeamName" >
        ...
        <telerik:GridNumericColumn DataField="Capacity" DecimalDigits="2" 
            ...
            UniqueName="Capacity" Visible="False">
        </telerik:GridNumericColumn>
<telerik:GridBoundColumn DataField="Status" HeaderText="狀態" UniqueName="Status" 
            FilterControlAltText="Filter Status column" Visible="False"></telerik:GridBoundColumn>
        <telerik:GridBoundColumn DataField="Des" 
            FilterControlAltText="Filter Des column" HeaderText="備註" UniqueName="Des" Visible="False">
        </telerik:GridBoundColumn>
...
<FilterMenu EnableImageSprites="False"></FilterMenu>
    ...
    <asp:Button ID="btnConfirm" runat="server" OnClick="btnConfirm_Click" OnClientClick="if(!confirm('儲存後將取代原本設定之名單，並清除教師設定，確定儲存?')){return false;}" Text="儲存" />
