...
public partial class EduScoreManage : AuthPage
{
    private List<EduScoreDto> CurrentData
    {
        get
        {
            return ViewState["CurrentData"] as List<EduScoreDto>;
        }
        set
        {
    ...
    protected void btnImport_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            List<string[]> result = service.UploadEduScore(dt, this.EmpCode);
    ...
    {
        List<EduScoreDto> data = service.QueryEduScoreData(tbEmpCodeName.Text.Trim(), tbCreater.Text.Trim(), rdpCreateSdate.SelectedDate, rdpCreateEdate.SelectedDate);
        CurrentData = data;
    ...
    protected void RadGrid1_DeleteCommand(object sender, GridCommandEventArgs e)
    {
        if (e.Item is GridDataItem)
        {
            ...
            ids.Add(id);
            string result = service.DeleteEduScoreData(ids);
            if (result != null)
            {
