<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="OSCEBlockTimeManage.aspx.cs" Inherits="OSCEBlockTimeManage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            <td>
                                ...
                                <asp:Label ID="Label21" runat="server" Text="課程日期："></asp:Label>
                    ...
                    <telerik:RadGrid ID="RadGrid1" runat="server" AutoGenerateColumns="False" AutoGenerateDeleteColumn="True" CellSpacing="0" Culture="zh-TW" GridLines="None" OnDeleteCommand="RadGrid1_DeleteCommand" OnNeedDataSource="RadGrid1_NeedDataSource" AllowMultiRowSelection="True">
                        ...
                        <MasterTableView DataKeyNames="ID">
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="classdate" FilterControlAltText="Filter classtype column" HeaderText="課程日期" UniqueName="classdate">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="TrainingTime" FilterControlAltText="Filter TrainingTime column" HeaderText="時數" UniqueName="TrainingTime">
                                </telerik:GridBoundColumn>
                            </Columns>
                        </MasterTableView>
                    </telerik:RadGrid>
    ...
    <div>
                ...
                <asp:Panel ID="Panel2" runat="server" GroupingText="Step1 - 下載匯入格式範例">
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/docs/學校BLOCK整合課程匯入範例.xls">下載</asp:HyperLink>
