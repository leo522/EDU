<%@ Control Language="C#" AutoEventWireup="true" CodeFile="跨領域開會紀錄_p.ascx.cs" Inherits="UserControls_跨領域開會紀錄_p" %>
    ...
    div.RadPicker table.rcSingle .rcInputCell{padding-right:0}div.RadPicker table.rcSingle .rcInputCell{padding-right:0}.RadPicker table.rcTable .rcInputCell{padding:0 4px 0 0}.RadPicker table.rcTable .rcInputCell{padding:0 4px 0 0}
          ...
          <asp:TextBox ID="TextBox10" runat="server"></asp:TextBox>
                    ...
                    <tr>
                        <td colspan="4" valign="top" width="705">
                            <p>
                                <span style="font-family: 標楷體;">主席<span lang="EN-US">(</span>主治醫師<span lang="EN-US">)</span>簽註意見：<asp:Literal ID="RadEditor8" runat="server"></asp:Literal>
                            </span>
                    ...
                    <tr>
                        <td valign="top" width="684">
                            <p style="line-height: 12pt;">
                                <span style="font-family: 標楷體;">牙醫師：<asp:Literal ID="RadEditor9" runat="server"></asp:Literal>
                            </span>
                        </td>
                    </tr>
                    <tr>
                        <td valign="top" width="684">
                            <p style="line-height: 12pt;">
                                <span style="font-family: 標楷體;">中醫師：<asp:Literal ID="RadEditor10" runat="server"></asp:Literal>
                            </span>
                        </td>
                    </tr>
                    <tr>
                        <td valign="top" width="684">
                            <p style="line-height: 12pt;">
                                <span style="font-family: 標楷體;">護理師：<asp:Literal ID="RadEditor11" runat="server"></asp:Literal>
                            </span>
                        </td>
                    </tr>
                    <tr>
                        <td valign="top" width="684">
                            <p style="line-height: 12pt;">
                                <span style="font-family: 標楷體;">藥師：<asp:Literal ID="RadEditor12" runat="server"></asp:Literal>
                            </span>
                        </td>
                    </tr>
                    <tr>
                        <td valign="top" width="684">
                            <p style="line-height: 12pt;">
                                <span style="font-family: 標楷體;">營養師：<asp:Literal ID="RadEditor13" runat="server"></asp:Literal>
                            </span>
                        </td>
                    </tr>
                    <tr>
                        <td valign="top" width="684">
                            <p style="line-height: 12pt;">
                                <span style="font-family: 標楷體;">檢驗師：<asp:Literal ID="RadEditor14" runat="server"></asp:Literal>
                            </span>
                        </td>
                    </tr>
                    <tr>
                        <td valign="top" width="684">
                            <p style="line-height: 12pt;">
                                <span style="font-family: 標楷體;">放射師：<asp:Literal ID="RadEditor15" runat="server"></asp:Literal>
                            </span>
                        </td>
                    </tr>
                    <tr>
                        <td valign="top" width="684">
                            <p style="line-height: 12pt;">
                                <span style="font-family: 標楷體;">呼吸治療師：<asp:Literal ID="RadEditor16" runat="server"></asp:Literal>
                            </span>
                        </td>
                    </tr>
                    <tr>
                        <td valign="top" width="684">
                            <p style="line-height: 12pt;">
                                <span style="font-family: 標楷體;">臨床心理師：<asp:Literal ID="RadEditor17" runat="server"></asp:Literal>
                            </span>
                        </td>
                    </tr>
                    <tr>
                        <td valign="top" width="684">
                            <p style="line-height: 12pt;">
                                <span style="font-family: 標楷體;">物理治療師：<asp:Literal ID="RadEditor18" runat="server"></asp:Literal>
                            </span>
                        </td>
                    </tr>
                    <tr>
                        <td valign="top" width="684">
                            <p style="line-height: 12pt;">
                                <span style="font-family: 標楷體;">職能治療師：<asp:Literal ID="RadEditor19" runat="server"></asp:Literal>
                            </span>
                        </td>
                    </tr>
                    <tr>
                        <td valign="top" width="684">
                            <p style="line-height: 12pt;">
                                <span style="font-family: 標楷體;">社工師：<asp:Literal ID="RadEditor20" runat="server"></asp:Literal>
                            </span>
                        </td>
                    </tr>
                    <tr>
                        <td valign="top" width="684">
                            <p style="line-height: 12pt;">
                                <span style="font-family: 標楷體;">其他：<asp:Literal ID="RadEditor21" runat="server"></asp:Literal>
                            </span>
                        </td>
                    </tr>
                </table>
