<%@ Control Language="C#" AutoEventWireup="true" CodeFile="跨領域開會紀錄_單一病人.ascx.cs" Inherits="UserControls_跨領域開會紀錄_單一病人" %>
...
mso-ansi-language:EN-US;mso-fareast-language:ZH-TW;mso-bidi-language:AR-SA">論</span></p>
            ...
            <telerik:RadEditor ID="RadEditor22" Runat="server" EditModes="Design" Height="170px" Width="547px">
                    <Tools>
                        <telerik:EditorToolGroup Tag="MainToolbar">
  ...
  style='font-family:標楷體'>職類別：</span></p>
  <p class=MsoNormal style='text-align:justify;text-justify:inter-ideograph'><span
  style='font-family:標楷體'>問題：</span></p>
  <p class=MsoNormal style='text-align:justify;text-justify:inter-ideograph'><span
  lang=EN-US style='font-family:標楷體'>&nbsp;</span></p>
  <p class=MsoNormal style='text-align:justify;text-justify:inter-ideograph'><span
  lang=EN-US style='font-family:標楷體'>                                 </span></p>
  <p class=MsoNormal style='text-align:justify;text-justify:inter-ideograph'><span
  style='font-family:標楷體'>建議措施：</span></p>
  <p class=MsoNormal style='text-align:justify;text-justify:inter-ideograph'><span
  lang=EN-US style='font-family:標楷體'>&nbsp;</span></p>
  <p class=MsoNormal style='text-align:justify;text-justify:inter-ideograph'><span
  lang=EN-US style='font-family:標楷體'>&nbsp;</span></p>
  <p class=MsoNormal style='text-align:justify;text-justify:inter-ideograph'><span
  style='font-family:標楷體'>目<span lang=EN-US>    </span>標：</span></p>
  <p class=MsoNormal style='text-align:justify;text-justify:inter-ideograph'><span
  lang=EN-US style='font-family:標楷體'>&nbsp;</span></p>
  ...
  lang=EN-US style='font-family:標楷體'>&nbsp;</span></p>
                                    ...
                                    <tr>
                                       <td colspan="5"><span style="font-family: 標楷體;"><span lang="EN-US">主持人總結：(</span>可列出建議措施和目標<span lang="EN-US">)</span><br />
                                           <telerik:RadEditor ID="RadEditor8" Runat="server" EditModes="Design" Height="170px" Width="547px">
                    <Tools>
                        <telerik:EditorToolGroup Tag="MainToolbar">
