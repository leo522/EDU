<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ERScoreManager.aspx.cs" Inherits="ERScoreManager" %>
...
<CommandItemTemplate>
    <asp:LinkButton ID="lbtnInsert" runat="server" OnClientClick="javascript:location.href='ERScoreEdit.aspx';return false;"><img style="border:0px" alt="" src="Images/add.jpg" /> 新增</asp:LinkButton>
