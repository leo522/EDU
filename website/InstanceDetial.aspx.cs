            ...
            if (Request.QueryString["instance_id"] != null)
            {
                ...
                if (edutermid != null)
                {
                    ...
                    if (eduterm != null)
                    {
                        ...
                        htmlform.ParameterCollection.Add("EduTermName", eduterm.Name);
...
//http://www2.kmuh.org.tw/Web/EduActivity/InstanceDetial.aspx?instance_id=381921
                ...
                if (dto != null)
                {
                    ...
                    if (rundown != null)
                    {
                        htmlform.ParameterCollection.Add("CoachID", rundown.CoachID);
                        htmlform.ParameterCollection.Add("CoachName", rundown.CoachName);
                        
                        
                        htmlform.ParameterCollection.Add("RName", rundown.RName);
                        htmlform.ParameterCollection.Add("CRName", rundown.CRName);
                        htmlform.ParameterCollection.Add("RID", rundown.RID);
                        htmlform.ParameterCollection.Add("CRID", rundown.CRID);
                    }

                    htmlform.ParameterCollection.Add("MemberTimeRange", dto.DateFrom.ToString("yyyy/MM/dd") + "~" + dto.DateTo.ToString("yyyy/MM/dd"));

                    htmlform.ParameterCollection.Add("MemberTimeRangeMD", dto.DateFrom.ToString("MM月dd日") + "~" + dto.DateTo.ToString("MM月dd日"));

                    htmlform.ParameterCollection.Add("MemberTimeRangeSY", dto.DateFrom.ToString("yyyy"));
                    htmlform.ParameterCollection.Add("MemberTimeRangeSM", dto.DateFrom.ToString("MM"));
                    htmlform.ParameterCollection.Add("MemberTimeRangeSD", dto.DateFrom.ToString("dd"));

                    htmlform.ParameterCollection.Add("MemberTimeRangeEY", dto.DateTo.ToString("yyyy"));
                    htmlform.ParameterCollection.Add("MemberTimeRangeEM", dto.DateTo.ToString("MM"));
                    htmlform.ParameterCollection.Add("MemberTimeRangeED", dto.DateTo.ToString("dd"));
                ...
                if (currentinstance.EvalTargetID != null)
                {
                    ...
                    htmlform.ParameterCollection.Add("EvalTimeRangeSY", evalmember.DateFrom.ToString("yyyy"));
                    htmlform.ParameterCollection.Add("EvalTimeRangeSM", evalmember.DateFrom.ToString("MM"));
                    htmlform.ParameterCollection.Add("EvalTimeRangeSD", evalmember.DateFrom.ToString("dd"));

                    htmlform.ParameterCollection.Add("EvalTimeRangeEY", evalmember.DateTo.ToString("yyyy"));
                    htmlform.ParameterCollection.Add("EvalTimeRangeEM", evalmember.DateTo.ToString("MM"));
                    htmlform.ParameterCollection.Add("EvalTimeRangeED", evalmember.DateTo.ToString("dd"));


                    V_KmuEmpDto evaltaremp = service.GetVKmuEmpByEmpCode(evalmember.IsHospMember);
                    if (evaltaremp != null)
                    {
                        htmlform.ParameterCollection.Add("EvalTargetLocName", evaltaremp.Locname);
                        htmlform.ParameterCollection.Add("EvalTargetDepName", evaltaremp.Deptname);
                        if (evaltaremp.SEX == 'F')
                        {
                ...
                if (htmlform.AfterInstances != null && htmlform.AfterInstances.Count > 0)
                {
                    ...
                    if (emp != null)
                    {
                        ...
                        htmlform.ParameterCollection.Add("NextLocName", emp.Locname);
                    }
