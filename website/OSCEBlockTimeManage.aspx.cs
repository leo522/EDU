...
public partial class OSCEBlockTimeManage : AuthPage
{
    private List<OSCEBlockTimeDto> CurrentData
    {
        get
        {
            return ViewState["CurrentData"] as List<OSCEBlockTimeDto>;
        }
        set
        {
    ...
    protected void btnImport_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            List<string[]> result = service.UploadOSCEBlockTime(dt, this.EmpCode);
    ...
    {
        List<OSCEBlockTimeDto> data = service.QueryOSCEBlockTimeEmpItemData(tbEmpCodeName.Text.Trim(), tbCreater.Text.Trim(), rdpSdate.SelectedDate, rdpEdate.SelectedDate, rdpCreateSdate.SelectedDate, rdpCreateEdate.SelectedDate);
        CurrentData = data;
    ...
    protected void RadGrid1_DeleteCommand(object sender, GridCommandEventArgs e)
    {
        if (e.Item is GridDataItem)
        {
            ...
            ids.Add(id);
            string result = service.DeleteOSCEBlockTimeEmpItemData(ids);
            if (result != null)
            {
