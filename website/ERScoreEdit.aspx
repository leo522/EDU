<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ERScoreEdit.aspx.cs" Inherits="ERScoreEdit" %>
...
<EnabledStyle Resize="None"></EnabledStyle>
                    ...
                    <tr>
                        <td class="style1" align="right">
                            <asp:Label ID="Label23" runat="server" Text="成績項目："></asp:Label>
                        </td>
                        <td>

                            <asp:Label ID="Label25" runat="server" Text="項目順序："></asp:Label>
...
<EnabledStyle Resize="None"></EnabledStyle>
                            ...
                            <br />
                            <asp:Label ID="Label24" runat="server" Text="項目名稱："></asp:Label>
                                ...
                                <telerik:RadGrid ID="rgStage" runat="server" AutoGenerateColumns="False" AutoGenerateDeleteColumn="True" CellSpacing="0" GridLines="None" OnDeleteCommand="rgStage_DeleteCommand" Culture="zh-TW">
                                    <MasterTableView DataKeyNames="ExamID,StageNo">
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="StageName" FilterControlAltText="Filter TargetName column" HeaderText="名稱" UniqueName="StageName">
                                            </telerik:GridBoundColumn>
                                        </Columns>
                                    </MasterTableView>
                                </telerik:RadGrid>
                    ...
                    <td>
                        <asp:Panel ID="panScore" runat="server" Visible="false">
                            <asp:HyperLink ID="linkSample" runat="server" NavigateUrl="~/docs/成績上傳範例.xls">上傳檔案範例</asp:HyperLink>
                                ...
                                <telerik:RadGrid ID="rgScore" runat="server" AutoGenerateColumns="False" CellSpacing="0" GridLines="None" Culture="zh-TW">
                                    <MasterTableView DataKeyNames="EmpCode,StageNo,ExamID">
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="StageNo" FilterControlAltText="Filter TargetName column" HeaderText="項目" UniqueName="StageNo">
                                            </telerik:GridBoundColumn>
