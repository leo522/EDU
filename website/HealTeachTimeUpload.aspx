<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="HealTeachTimeUpload.aspx.cs" Inherits="HealTeachTimeUpload" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <div>
        <table>
            <tr>
                <td><asp:Label ID="Label1" runat="server" Text="上傳資料年："></asp:Label></td>
                <td>    <asp:DropDownList ID="ddlYear" runat="server">
    </asp:DropDownList></td>
                <td><asp:Label ID="Label2" runat="server" Text="月份："></asp:Label></td>
                <td><asp:DropDownList ID="ddlMonth" runat="server">
    </asp:DropDownList></td>
                <td><asp:Label ID="Label3" runat="server" Text="部門："></asp:Label>
                </td>
                <td>
                ...
                &nbsp;
                    <asp:Button ID="btnClean" runat="server" OnClientClick="javascript:if(!confirm('是否確定清空該部門當月資料?')){ return false;}" OnClick="btnClean_Click" Text="清空該月資料" />
    ...
    <div>
        <table>
            <tr>
                <td>
                    <asp:Label ID="Label4" runat="server" Text="選擇檔案："></asp:Label>
                    <br />
                    <asp:Label ID="Label6" runat="server" Text="檔案格式請參考"></asp:Label>
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/醫療與教學並行時數範例.xls">範例</asp:HyperLink>
                </td>
                <td>
                    <telerik:RadAsyncUpload ID="rauTeachTime" runat="server" MaxFileInputsCount="1" Width="230px">
                    </telerik:RadAsyncUpload>
                </td>
                <td>
                    <asp:Button ID="btnSubmit" runat="server" OnClick="btnSubmit_Click" Text="上傳" />
                </td>
            </tr>
    ...
    <div>
        ...
        <asp:Label ID="Label5" runat="server" Text="上傳結果："></asp:Label>

    </div>
    <div>

        <asp:Literal ID="liResult" runat="server"></asp:Literal>

    </div>
    <div>

        <telerik:RadGrid ID="rgTime" runat="server" AutoGenerateColumns="False" CellSpacing="0" GridLines="None" AutoGenerateDeleteColumn="True" OnDeleteCommand="rgTime_DeleteCommand">
            <MasterTableView DataKeyNames="ID">
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="TargetTypeName" FilterControlAltText="Filter TargetTypeName column" HeaderText="授課對象" UniqueName="TargetTypeName">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="ActTypeName" FilterControlAltText="Filter ActTypeName column" HeaderText="教學活動" UniqueName="ActTypeName">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="TeachTime" FilterControlAltText="Filter TeachTime column" HeaderText="時數" UniqueName="TeachTime">
                    </telerik:GridBoundColumn>
                </Columns>
            </MasterTableView>
        </telerik:RadGrid>
